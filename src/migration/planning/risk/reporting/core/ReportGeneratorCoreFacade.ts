/**
 * ReportGeneratorCore - Auto-generated Facade (Phase 1.3)
...
export class ReportGeneratorCore extends EventEmitter {
...
export default ReportGeneratorCore;
