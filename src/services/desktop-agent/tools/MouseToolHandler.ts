...
|--------:|-----------|-------------|----------------|-----------|--------|-------|------|------|
| 1.0.0   | 2025-09-28T12:52:15-04:00 | AGENT104@sonnet-4 | Extract MouseToolHandler from computer-use.tools | MouseToolHandler.ts | OK | Mouse operations split, <60 lines per function | 0.00 | f7e2a9d |
