...
|--------:|-----------|-------------|----------------|-----------|--------|-------|------|------|
| 1.0.0   | 2025-09-28T10:25:32-04:00 | decomposer@claude-sonnet-4 | Created PhaseDefinitionTypes.ts - phase core interfaces | PhaseDefinitionTypes.ts | OK | Extracted phase definition types, <500 lines | 0.00 | g3c8f9d |
