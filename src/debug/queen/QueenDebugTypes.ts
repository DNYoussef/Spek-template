/**
 * Queen Debug Types - Comprehensive Type Definitions
 * NASA Rule 10 Compliant: All functions ≤60 lines, no recursion
 * FSM-First Design: Type-safe state machine contracts
 */
 ...
 * |--------:|-----------|-------------|----------------|-----------|--------|-------|------|------|
 * | 1.0.0   | 2025-09-27T21:45:12-04:00 | coder@claude-sonnet-4 | Create QueenDebugTypes.ts with FSM-First type definitions | QueenDebugTypes.ts | OK | NASA Rule 10 compliant factory functions ≤60 lines | 0.00 | a7f8c2d |
 * ### Receipt
 * - status: OK
 * - reason_if_blocked: --
 * - run_id: nasa-rule10-decomposition-001
