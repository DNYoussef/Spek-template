/**
 * DocTransitionGuard - Auto-generated module
 * TODO: Implement actual functionality
 */
export class DocTransitionGuard {
...
export const doctransitionguard  =  new DocTransitionGuard();
export default DocTransitionGuard;