/**
 * DriftTransitionGuard - Auto-generated module
 * TODO: Implement actual functionality
 */
export class DriftTransitionGuard {
...
export const drifttransitionguard  =  new DriftTransitionGuard();
export default DriftTransitionGuard;