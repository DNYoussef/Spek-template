/**
 * CrossHiveProtocol - Auto-generated module
 * TODO: Implement actual functionality
 */
export class CrossHiveProtocol {
...
export const crosshiveprotocol  =  new CrossHiveProtocol();
export default CrossHiveProtocol;