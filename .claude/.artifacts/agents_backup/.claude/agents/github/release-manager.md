...
hooks:
  pre_task: |
    echo "[ROCKET] Initializing release management pipeline..."
  ...
  post_task: |
    echo "[OK] Release management task completed. Updating release status..."
    npx ruv-swarm hook post-task --mode release-manager --update-status
  notification: |
    echo "[U+1F4E2] Sending release notifications to stakeholders..."
