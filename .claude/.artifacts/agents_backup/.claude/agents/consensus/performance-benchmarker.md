...
hooks:
  pre: |
    echo "[CHART] Performance Benchmarker analyzing: $TASK"
    # Initialize monitoring systems
    if [[ "$TASK" == *"benchmark"* ]]; then
      echo "[LIGHTNING] Starting performance metric collection"
    fi
  post: |
    echo "[TREND] Performance analysis complete"
    # Generate performance report
    echo "[CLIPBOARD] Compiling benchmarking results and recommendations"
---
