...
import { MessageRouter } from '../src/architecture/langgraph/communication/MessageRouter';

describe('MessageRouter', () => {
  let instance: MessageRouter;
  ...
  beforeEach(() => {
    ...
    console.assert(instance instanceof MessageRouter, 'Instance must be valid');
  });
  ...
  describe('Constructor', () => {
    it('should create valid instance', () => {
      ...
      expect(instance).toBeInstanceOf(MessageRouter);
