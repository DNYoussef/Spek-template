...
class FinalUnicodeCleanup:
    ...
    def aggressive_unicode_cleanup(self, text):
        ...
        unicode_map = {
            ...
            # Math symbols
            '<=': '<=', '>=': '>=', '!=': '!=', '~=': '~=', '+/-': '+/-',
            'x': 'x', '?': '/', 'inf': 'infinity', '?': 'sum', '?': 'product',
            'sqrt': 'sqrt', '?': 'delta', '?': 'nabla', '?': 'partial',
            ...
            # Special characters
            'deg': 'deg', '(TM)': '(TM)', '(R)': '(R)', '(c)': '(C)', '?': 'section',
            '?': 'P', '?': '+', '?': '++', '?': '%', '?': '%',

            # Fractions
            '1/2': '1/2', '?': '1/3', '1/4': '1/4', '3/4': '3/4', '?': '1/5',
            '?': '1/6', '?': '1/8', '?': '2/3', '?': '2/5', '?': '3/5',
            '?': '4/5', '?': '7/8',
