...
async function debugThreeJSAnimations() {
    ...
    page.on('response', response => {
        if (response.url().includes('three') || response.url().includes('.js')) {
            ...
            const statusIcon = status >= 200 && status < 300 ? '[OK]' : '[FAIL]';
    ...
    try {
        ...
        console.log(`Three.js Available: ${threeJSAvailable ? '[OK] YES' : '[FAIL] NO'}`);
        ...
        console.log(`UltraSolarpunkEcosystem Class: ${ecosystemClassAvailable ? '[OK] YES' : '[FAIL] NO'}`);
        ...
        console.log(`Main Container (#ecosystem-container): ${mainContainerExists ? '[OK] EXISTS' : '[FAIL] MISSING'}`);
        ...
        scriptInfo.forEach(script => {
            const status = script.loaded ? '[OK]' : '[FAIL]';
        ...
        if (threeJSAvailable && ecosystemClassAvailable) {
            ...
            console.log(`Manual Init Result: ${initResult.success ? '[OK] SUCCESS' : '[FAIL] FAILED'}`);
        ...
        console.log(`  Window Loaded: ${domAnalysis.windowLoaded ? '[OK]' : '[FAIL]'}`);
        ...
        console.log('\n? SUMMARY REPORT');
        console.log('================');
        console.log(`Three.js Available: ${threeJSAvailable ? '[OK]' : '[FAIL]'}`);
        console.log(`UltraSolarpunkEcosystem Available: ${ecosystemClassAvailable ? '[OK]' : '[FAIL]'}`);
        console.log(`Canvas Elements: ${canvasCount}`);
        console.log(`Main Container: ${mainContainerExists ? '[OK]' : '[FAIL]'}`);
