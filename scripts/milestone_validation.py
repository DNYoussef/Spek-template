from src.constants.base import DAYS_RETENTION_PERIOD, QUALITY_GATE_MINIMUM_PASS_RATE
...
def _validate_criteria(self, criteria: Dict[str, Any]) -> bool:
        ...
        criteria_checks = {
            "test_assertion_ratio": lambda v: v >= 0.8,
...
def _run_correlation_analysis(self) -> bool:
        ...
        correlations = {
            "code_changes_vs_coverage": QUALITY_GATE_MINIMUM_PASS_RATE,
